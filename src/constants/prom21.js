...
export const SHARE_SOCIAL = (args) => {
  var t = window.app21 || {};
  if (typeof t.prom !== "undefined") {
    return t.prom("SHARE_SOCIAL", args);
  }
};

/**
 * ##DOWNLOAD_FILES
 * @param {string} args JSON.stringify([image])
 */

export const DOWNLOAD_FILES = (args) => {
  if (typeof t.prom !== "undefined") {
    return t.prom("DOWNLOAD_FILES", args);
  }
}
