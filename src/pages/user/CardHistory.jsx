        ...
        <Navbar>
          <div className="page-navbar">
            ...
            <div className="page-navbar__title">
              <span className="title">Lịch sử thẻ tiền</span>
            </div>
          ...
          <div>
            ...
            {!loading && (
              <>
                {Member &&
                  Member.MoneyKinds &&
                  Member.MoneyKinds["[Kích hoạt tài khoản ]"] &&
                  Member.MoneyKinds["[Kích hoạt tài khoản ]"].length > 0 &&
                  Member.MoneyKinds["[Kích hoạt tài khoản ]"].map(
                    (item, index) => (
                ...
                {(!Member ||
                  ...
                  !Member.MoneyKinds["[Kích hoạt tài khoản ]"] ||
                  (Member.MoneyKinds["[Kích hoạt tài khoản ]"] &&
                    Member.MoneyKinds["[Kích hoạt tài khoản ]"].length ===
                      0)) && <PageNoData text="Không có dữ liệu." />}
              </>
            )}
          </div>
        </div>
